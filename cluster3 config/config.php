...
$file1=filesize("epiz_25638021_Cluster");
...
if (!file_exists("epiz_25638021_Cluster.sql") || $file1==0)
{
$file = fopen("epiz_25638021_Cluster.sql");
flock($file,LOCK_UN);
fclose($file);	
$url='http://faleristics4eforever.epizy.com/epiz_25638021_Cluster.sql';
$path='epiz_25638021_Cluster.sql';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
